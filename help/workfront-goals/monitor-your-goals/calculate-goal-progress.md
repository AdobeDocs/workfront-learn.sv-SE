...
* **Faktisk procent slutfört** - Hur mycket av målet som faktiskt har slutförts hittills. Det här värdet är ett genomsnitt av hur många procent färdigt alla förloppsindikatorer som är associerade med målet är.
* **Förväntad procent slutfört** - Hur mycket av målet ska slutföras, vid den här tidpunkten, för att målet ska kunna slutföras i tid. Det här värdet beräknas utifrån målets varaktighet (totalt antal dagar) och det aktuella tidsmomentet (totalt antal dagar sedan målets startdatum).
* **Progress** - Förloppet är en etikett som anger om målet är på väg att slutföras i tid eller om det är i fara eller om det är i problem att inte slutföras.
...
Förloppet för ditt mål är ett bra sätt att få en uppfattning om var ditt mål är när det gäller att slutföra baserat på uppdateringar som du har lagt in i systemet. Därför är det så viktigt att uppdatera dina aktiviteter och resultat i Målen. Med förloppsetiketter kan man förmedla en standardiserad status till resten av organisationen.
