...
+ Hantera arbete {#manage-work}
   ...
   + Godkännandeprocesser och milstolpar {#approval-processes-and-milestone-paths}
      + [Skapa och hantera godkännandeprocesser](/help/manage-work/approval-processes-and-milestone-paths/create-a-single-use-approval-process.md)
   ...
   + Skapa och hantera projektmallar {#create-and-manage-project-templates}
      ...
      + [Installera och använda en utkast](/help/manage-work/create-and-manage-project-templates/install-and-use-a-blueprint.md)
...
+ Workfront Planning {#workfront-planning}
   ...
   + [Koppla posttyper](/help/workfront-planning/connect-record-types.md)
   + [Skapa ett formulär för posttypsbegäran](/help/workfront-planning/create-a-record-type-request-form.md)
